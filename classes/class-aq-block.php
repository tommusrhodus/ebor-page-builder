...
if(!class_exists('AQ_Block')) {
	class AQ_Block {
	 	...
	 	function update($new_instance, $old_instance) {
	 		$new_instance = array_map('array_htmlspecialchars', array_map('stripslashes_deep', $new_instance));
	 		return $new_instance;
	 	}
	 	...
	 	function before_form($instance) {
	 		...
	 		(isset($block_icon)) ? $block_icon = $block_icon : $block_icon = '';
	 		(isset($block_description)) ? $block_description = '<small>' . $block_description . '</small>' : $block_description = '';
	 				...
	 				'<dl class="block-bar">',
	 					'<dt class="block-handle">',
	 						'<div class="block-title">',
	 							$block_icon, $name , $title, $block_description,
	 						'</div>',
